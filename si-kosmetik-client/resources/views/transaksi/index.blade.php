                            ...
                            <div class="modal-content">
                                ...
                                <form class="forms-sample" action="{{ route('transaksi.store') }}" method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label for="kosmetik">Kosmetik</label>
                                            <select id="kosmetik" class="form-control" id="exampleFormControlSelect2"
                                                name="nama_produk_kosmetik">
                                                <option>- Pilih Kosmetik -</option>
                                                @foreach ($fixkosmetik as $fk)
                                                    <option value="{{ $fk['nama_produk'] }}"
                                                        id="{{ $fk['harga_produk'] }}">
                                                        {{ $fk['nama_produk'] }}
                                                    </option>
                                                @endforeach
                        ...
                        <tbody>
                            @foreach ($data as $transaksi)
                                <tr>
                                    ...
                                    <td>{{ $transaksi['nama_produk_kosmetik'] }}</td>
                                    <td>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    Nama Kosmetik :
                                                                    {{ $transaksi['nama_produk_kosmetik'] }}
                                                                </li>
                                                                <li>
